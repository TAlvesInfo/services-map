...
|------------|--------------|--------|
| Python 3.8+ | Project runtime | Required |
| GeoJSON world data | Map rendering | To be sourced |
| bizAPIs service metadata | Country/service data | Available in codebase |
...
- Sprint Management initialized (v2.2.0)
